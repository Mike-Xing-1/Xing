...
loop_length = 0.12;  % The side length of the ring antenna
loop_radi = 0.01;  % The radius of the loop antenna
cell_x = 0.5 / 68;  % cell dimension
loop_nd = floor(loop_length / cell_x) + 1;
...
dx(x_mid, yc, z1) = source(n);
dx(x_mid, yc, z2) = source(n);
